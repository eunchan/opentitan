...
### Checklists for milestone V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_PLAN_DRAFT_COMPLETED][]           | Done        | [rv_plic_fpv_plan]({{<relref "dv_plan/index.md" >}})
